...
var frontMembers = [];
var imbed;
var token = "VDbu2237YYBBCLv1WK17I3EakZtuVcRlHBTOI0etbYVV6hl8psi9HmIqreP7puQk";
...
function makeFronterElements(imbed) {
    for (let i = 0; i < Object.keys(fronters).length; i++) {
        ...
        imbed.innerHTML += '<div class="mcont" "&' + frontMembers[i].content.name + '"><div class="fstatus">' + frontMembers[i].content.customStatus + '</div><img class="favi" src="' + frontMembers[i].content.avatarUrl + '"><div class="fname">' + frontMembers[i].content.name + '</div><div class=fpro>' + frontMembers[i].content.pronouns + '</div><div class="fdesc">' + frontMembers[i].content.desc + '</div></div>'
        console.log(i)
